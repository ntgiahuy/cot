...
4. **Đai C** — chỉ khi Cx hoặc Cy lẻ (có thép chủ giữa để móc). Cx lẻ → đai **đứng** móc thanh giữa cạnh trên/dưới. Cy lẻ → đai **ngang** móc thanh giữa cạnh trái/phải. Cả hai chẵn thì không dùng đai C.
