...
Trọng lượng tính theo `d² / 162.2` (kg/m). **Nối so le** chỉ chọn một: chân cột (50% nD / 50% 2nD) hoặc giữa cột (vị trí (H tầng − H dầm)/2; 50% tại đó, 50% lệch thêm nD). Bảng thống kê thép dọc một cây cột từ dưới lên — cùng kích thước, Ø và hình gộp một số hiệu (1 hoặc 1a, 1b…). Thép nổ ghi số hiệu đó trong vòng tròn thẳng cột, đặt tại trung điểm thanh; line chỉ vào thanh, số lượng và Ø (ví dụ 4Ø16) nằm giữa line; tầng mái bẻ móc 10d, trừ da bảo vệ đỉnh cột 50 mm.
