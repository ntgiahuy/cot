...
4. **Đai C** — tick bố trí Cx/Cy (cạnh lẻ). **Đai lồng** cùng bố cục, chỉ khi Cx/Cy ≥ 4 thanh. Số cây ôm = 1/3 số thép mặt đó (làm tròn lên, tối thiểu 2). Cạnh ngắn = `n×Ø + (n−1)×hở`. **Đai kép** cùng form Cx/Cy; mỗi phía ôm ≥ 2/3 số thép, cạnh ngắn = max(ôm thanh, 2/3 nhịp đai). Đai lồng và đai kép không dùng đồng thời; đai kép thì bỏ đai đơn.
