...
2. **Add / Edit** — khai báo tên cột, số lượng, Cx × Cy (hoặc **đường kính D** khi chọn **Cột tròn**), phạm vi tầng.
3. Nhấp ô cột trên mặt đứng để **bố trí thép** (số thanh cạnh Cx/Cy từ 2 đến 100; Ø 6, 8, 10, 12, 14, 16, 18, 20, 22, 25, 28, 32, 36, 40, 45, 50, 55). Tick *Sử dụng cốt thép đã bố trí cho các tầng trên* nếu muốn copy lên tầng trên. **Cột tròn**: thép chủ xếp đều trên vòng tròn **trong** đai; bảng thống kê vẽ đai vòng (πD + 2 móc).
...
Trọng lượng tính theo `d² / 162.2` (kg/m). **Nối so le** chỉ chọn một: chân cột (50% nD / 50% 2nD) hoặc giữa cột (vị trí (H tầng − H dầm)/2; 50% tại đó, 50% lệch thêm nD). Bảng thống kê thép dọc một cây cột từ dưới lên — cùng kích thước, Ø và hình gộp một số hiệu (1 hoặc 1a, 1b…). Thép nổ đặt cách mặt đứng cột; số hiệu trong vòng tròn bên phải line ngắn; tầng mái bẻ móc 10d, trừ da bảo vệ đỉnh cột 50 mm.
